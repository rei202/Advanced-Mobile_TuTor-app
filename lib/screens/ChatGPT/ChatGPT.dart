...
import 'components/BottomInput.dart';
import 'components/MessageItem.dart';

const List<String> list = <String>['Vietnamese', 'English'];
List<Map<String,String>> messages = [];

class ChatGPT extends ConsumerStatefulWidget {
  const ChatGPT({super.key});

  @override
  ConsumerState<ChatGPT> createState() => _HomePageState();
}

class _HomePageState extends ConsumerState<ChatGPT> {
